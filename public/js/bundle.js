...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51RT2X9R7OZZIVCxDnf8DdIZX68UHgNcpWop6hLw2OtGcbv4OHwzNG32LVTRO9VCkVUToqtAigMnlrKRFe3EFh9Iz00XyQ4M2VT');
...
var reviewDeleteBtns = document.querySelectorAll('.delete-review');
...
if (reviewForm) reviewForm.addEventListener('submit', function (e) {
  ...
  var tourId = e.target.dataset.tourId;
  (0, _review.createReview)(review, rating, tourId);
});
if (reviewDeleteBtns.length) {
  reviewDeleteBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      var reviewId = e.target.dataset.reviewId;
      if (reviewId) (0, _review.deleteReview)(reviewId);
    });
  });
}
document.addEventListener('click', function (e) {
  var btn = e.target.closest('.btn--edit-review');
  if (!btn) return;
  console.log('Edit button clicked!');
  var reviewId = btn.dataset.reviewId;
  var reviewContent = btn.dataset.reviewContent;
  var reviewRating = btn.dataset.reviewRating;
  var reviewDiv = btn.closest('.reviews__card');
  reviewDiv.innerHTML = "\n    <textarea id=\"edit-review-text\" class=\"form__input\" rows=\"3\">".concat(reviewContent, "</textarea>\n    <select id=\"edit-review-rating\" class=\"form__input\">\n      ").concat([1, 2, 3, 4, 5].map(function (num) {
    return "\n        <option value=\"".concat(num, "\" ").concat(num == reviewRating ? 'selected' : '', ">").concat(num, "</option>\n      ");
  ...
  document.getElementById('save-review').addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var updatedText, updatedRating, res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          updatedText = document.getElementById('edit-review-text').value;
          updatedRating = document.getElementById('edit-review-rating').value;
          _context2.prev = 2;
          _context2.next = 5;
          return axios.patch("http://127.0.0.1:3000/api/v1/reviews/".concat(reviewId), {
            review: updatedText,
